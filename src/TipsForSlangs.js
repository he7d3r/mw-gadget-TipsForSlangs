...
( function ( mw, $ ) {
	...
	var slangs = {
		...
		EC: 'Eliminação por consenso',
		ER: 'Eliminação rápida',
		...
		R3R: 'Regra que impede um mesmo usuário de fazer mais de três reversões no período de 24 horas',
